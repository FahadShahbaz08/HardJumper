...
public class Player : MonoBehaviour
{
    ...
    //            //    else if (inputY < 0 && Mathf.Abs(inputY) > Mathf.Abs(inputX))
    //            //    {
    //            //        characterDuck();
    //            //    }
    ...
    //        else
    //        {
    //            if (deltaX > 0 && characterRGBD.transform.position.x < 1.75f - 0.385f)
    //            {
    //                // Swipe Right
    //                characterRGBD.transform.position = new Vector3(characterRGBD.transform.position.x + 1.75f, characterRGBD.transform.position.y, transform.position.z);
    //            }
    //            else if (deltaX < 0 && characterRGBD.transform.position.x > -1.75f - 0.385f)
    //            {
    //                // Swipe Left
    //                characterRGBD.transform.position = new Vector3(characterRGBD.transform.position.x - 1.75f, characterRGBD.transform.position.y, transform.position.z);
    //            }
